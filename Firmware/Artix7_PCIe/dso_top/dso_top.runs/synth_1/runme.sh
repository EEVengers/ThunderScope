...
HD_PWD='C:/Users/Aleksa/Documents/FPGA_Dev/Artix7_PCIe/DDR3_Optimization/dso_top/dso_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dso_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dso_top.tcl
