...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXI1 [get_bd_intf_pins xdma_0/M_AXI] [get_bd_intf_pins axi_dwidth_converter_0/S_AXI]
...
proc create_hier_cell_Memory { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins clk_wiz_0/resetn]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins mig_7series_0/sys_rst]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins PCIe/axi_aclk] [get_bd_pins Memory/ACLK] [get_bd_pins Datamover/axi_aclk] [get_bd_ports axi_aclk] [get_bd_pins AXI_LITE_IO/axi_aclk]
