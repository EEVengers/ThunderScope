...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  connect_bd_net -net xdma_0_user_lnk_up [get_bd_pins user_lnk_up_0] [get_bd_pins xdma_0/user_lnk_up]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net PCIe_user_lnk_up_0 [get_bd_pins Memory/resetn_0] [get_bd_pins PCIe/user_lnk_up_0]
