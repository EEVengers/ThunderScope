...
set_property -dict {PACKAGE_PIN M1 IOSTANDARD LVCMOS33} [get_ports {term[0]}]
set_property -dict {PACKAGE_PIN M5 IOSTANDARD LVCMOS33} [get_ports {term[1]}]
set_property -dict {PACKAGE_PIN R3 IOSTANDARD LVCMOS33} [get_ports {pga_cs[1]}]
set_property -dict {PACKAGE_PIN P5 IOSTANDARD LVCMOS33} [get_ports {atten[2]}]

set_property -dict {PACKAGE_PIN P4 IOSTANDARD LVCMOS33} [get_ports {dc_cpl[0]}]
set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS33} [get_ports {dc_cpl[1]}]
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports {term[2]}]
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {pga_cs[2]}]

set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {atten[0]}]
set_property -dict {PACKAGE_PIN N2 IOSTANDARD LVCMOS33} [get_ports {atten[1]}]
...
set_property -dict {PACKAGE_PIN N1 IOSTANDARD LVCMOS33} [get_ports {pga_cs[0]}]
...
set_property -dict {PACKAGE_PIN L4 IOSTANDARD LVCMOS33} [get_ports {term[3]}]

set_property -dict {PACKAGE_PIN M6 IOSTANDARD LVCMOS33} [get_ports {dc_cpl[3]}] 

set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {atten[3]}] 

set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33} [get_ports {pga_cs[3]}] 
